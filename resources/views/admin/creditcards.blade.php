        ...
        <div class="col-md-4">
            <div class="card border-info bg-dark text-light p-5">
                ...
                <div class="text-center">
                    ...
                    <a href="{{ url('/dashboard/generateCards_i', 300) }}" class="btn btn-warning"> x 300 </a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card border-info bg-dark text-light p-5">
                ...
                <div class="text-center">
                    ...
                    <a href="{{ url('/dashboard/generateCards_ii', 300) }}" class="btn btn-warning"> x 300 </a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card border-info bg-dark text-light p-5">
                ...
                <div class="text-center">
                    ...
                    <a href="{{ url('/dashboard/generateCards_iii', 300) }}" class="btn btn-warning"> x 300 </a>
                </div>
            </div>
        </div>
